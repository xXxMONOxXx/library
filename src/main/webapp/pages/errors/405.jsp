...
<head>
    ...
    <title><fmt:message key="error.405"/></title>
</head>
<body>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12 text-center">
                <span class="display-1 d-block"><fmt:message key="error.405"/></span>
                <div class="mb-4 lead"><fmt:message key="error.method_not_allowed"/></div>
